...
class ProjectController extends ResourceController
{
    ...
    protected function fields(Model $record): array
    {
        return [
            ...
            Field::text('card_tag', 'Card tag')->rules('max:120')->help('Small red label on cards, e.g. "Battery · Case study".'),
            Field::textarea('summary', 'Summary')->rules('max:500')->help('One or two sentences: the problem in brief.'),
            ...
            Field::text('result_headline', 'Result in one line')->rules('max:160')->help('Shown at the foot of the card. Should be a number, e.g. "Damage claims down 60%".'),
