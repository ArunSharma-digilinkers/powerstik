...
<a href="{{ $href }}" @if (str_starts_with($href, 'https://wa.me')) target="_blank" rel="noopener" @endif data-track="whatsapp_float"
   class="fixed right-4 bottom-4 z-[60] grid size-14 place-items-center rounded-full bg-ink text-white shadow-[0_8px_26px_rgba(0,0,0,.28)] transition-colors hover:bg-brand-500 hover:text-ink sm:right-[26px] sm:bottom-[26px] sm:size-[60px]">
